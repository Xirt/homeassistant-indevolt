    ...
    async def _async_update_data(self) -> dict[str, Any]:
        ...
        try:
            if get_device_gen(self.config["device_model"]) == 1:
                ...
                keys = [0, 7101, 142, 6105, 2618, 11009, 2101, 2108, 11010, 2108, 667, 2107, 2104, 2105, 11034, 1502, 6004, 6005, 6006, 6007, 7120, 11016, 2600, 2612, 6001, 6000, 6002, 1502, 1501, 1532, 1600, 1632, 1664, 1633, 1601, 1665, 1634, 1602, 1666, 1635, 1603, 1667, 11011]  # fmt: skip
